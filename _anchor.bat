...
export anchorSourceDir="scriptedIllustrator"
export anchorSource="tinyCompiler_scriptedIllustrator.sh"
...
SET "MSWanchorSourceDir=scriptedIllustrator"

SET "MSWanchorSource=tinyCompiler_scriptedIllustrator.sh"
